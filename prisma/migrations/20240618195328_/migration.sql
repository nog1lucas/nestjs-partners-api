-- AlterTable
ALTER TABLE `Event` ADD COLUMN `reservationHistoryId` VARCHAR(191) NULL;
...
-- AddForeignKey
ALTER TABLE `Event` ADD CONSTRAINT `Event_reservationHistoryId_fkey` FOREIGN KEY (`reservationHistoryId`) REFERENCES `ReservationHistory`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
